<template>
  <div v-if="hasError" class="min-h-screen flex items-center justify-center bg-black">
    <div class="text-center p-8">
      <!-- Error Icon -->
      <div class="w-24 h-24 mx-auto mb-6 bg-red-900/50 rounded-full flex items-center justify-center">
      ...
      <div v-if="error && isDevelopment" class="mt-8 p-4 bg-red-900/20 rounded-lg border border-red-700/50">
