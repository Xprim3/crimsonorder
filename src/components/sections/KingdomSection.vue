<template>
  <section id="kingdom" class="relative min-h-screen flex items-center justify-center py-8 sm:py-12 lg:py-16 xl:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16" style="background: #1A1A1A;">
    <!-- Background Effects -->
    ...
    <div class="relative z-10 w-full max-w-6xl mx-auto">
      ...
      <div class="text-center mb-12 lg:mb-16">
        ...
        <p class="text-xl text-gray-300 mt-6 max-w-3xl mx-auto">
          Experience the pinnacle of Rise of Kingdoms with the most elite family in the game
        </p>
      </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div class="text-center lg:text-left">
            ...
            <p class="text-lg text-gray-200 leading-relaxed">
              Join the most prestigious kingdom where legends are made. Experience non-stop action, 
              strategic warfare, and a community that feels like family.
            </p>
          </div>
          ...
          <div class="text-center">
            <div class="bg-gradient-to-br from-yellow-500/20 to-red-600/20 rounded-2xl p-8 border-2 border-yellow-500/50">
              ...
              <div class="space-y-3">
                <button class="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-bold py-3 px-6 rounded-lg hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105">
                  🚀 Start Migration Now
                </button>
                <button class="w-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold py-3 px-6 rounded-lg hover:from-red-500 hover:to-red-600 transition-all duration-300 transform hover:scale-105">
                  💬 Ask Questions
                </button>
              </div>
            </div>
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800 mb-16">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-300">
            Discover the advantages that make our kingdom the ultimate destination for serious players
          </p>
        </div>
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800 mb-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <!-- King -->
          <div class="bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 rounded-2xl p-8 border-2 border-yellow-500/50 text-center group hover:border-yellow-400/70 transition-all duration-300">
            ...
            <p class="text-gray-200 text-sm leading-relaxed">
              A legendary commander who has led our kingdom to countless victories. 
              Known for his strategic brilliance and fair leadership.
            </p>
          </div>
          
          <!-- Queen -->
          <div class="bg-gradient-to-br from-red-500/20 to-red-600/20 rounded-2xl p-8 border-2 border-red-500/50 text-center group hover:border-red-400/70 transition-all duration-300">
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-300">
            Follow these simple steps to become part of the legendary Crimson Order family
          </p>
        </div>
        ...
        <div class="text-center mt-12">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <button class="bg-gradient-to-r from-red-600 to-red-700 text-white font-bold py-4 px-8 rounded-lg hover:from-red-500 hover:to-red-600 transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
              <span>📱</span>
