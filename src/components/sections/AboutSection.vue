  ...
  <section id="about" class="relative min-h-screen flex items-center justify-center py-8 sm:py-12 lg:py-16 xl:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16" style="background: #1A1A1A;">
    ...
    <div class="relative z-10 w-full max-w-6xl mx-auto">
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800 mb-16 relative overflow-hidden">
        <!-- Decorative Elements -->
        <div class="absolute top-4 right-4 text-yellow-500 font-bold text-sm tracking-wider opacity-50">EST. 2023</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div class="flex justify-center lg:justify-start">
            <div class="w-32 h-32 sm:w-40 sm:h-40 bg-gradient-to-br from-red-900 via-red-800 to-red-700 rounded-full flex items-center justify-center border-4 border-yellow-500 shadow-2xl relative group hover:border-yellow-400 transition-all duration-300">
              <div class="absolute inset-0 bg-gradient-to-br from-red-600 to-transparent opacity-30 rounded-full group-hover:opacity-50 transition-opacity duration-300"></div>
              <div class="absolute inset-0 bg-gradient-to-br from-yellow-500 to-transparent opacity-10 rounded-full group-hover:opacity-20 transition-opacity duration-300"></div>
              <div class="relative z-10 text-center">
                <div class="text-2xl sm:text-3xl font-black text-white mb-1 group-hover:text-yellow-100 transition-colors duration-300">CO</div>
                <div class="text-xs sm:text-sm font-bold text-yellow-400 tracking-wider group-hover:text-yellow-300 transition-colors duration-300">FAMILY</div>
              </div>
            </div>
          </div>
          ...
          <div class="lg:col-span-2">
            <h3 class="text-2xl sm:text-3xl font-bold mb-6 text-yellow-400">
              The Legend of Crimson Order
            </h3>
            <p class="text-lg sm:text-xl leading-relaxed text-gray-200 mb-6">
              Born from the ashes of countless battles, <span class="text-yellow-400 font-semibold">Crimson Order</span> emerged as a beacon of hope in the chaotic world of Rise of Kingdoms. 
            ...
            <p class="text-lg sm:text-xl leading-relaxed text-gray-200 mb-6">
              Our story is one of <span class="text-yellow-400 font-semibold">unbreakable bonds</span>, <span class="text-yellow-400 font-semibold">strategic brilliance</span>, and <span class="text-yellow-400 font-semibold">unwavering loyalty</span>. 
            ...
            <p class="text-lg sm:text-xl leading-relaxed text-gray-200">
              ...
              We are not just warriors—we are a <span class="text-yellow-400 font-semibold">family forged in fire</span>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800 mb-16">
        ...
        <div class="mb-12">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-red-900/60 to-red-800/60 rounded-2xl p-8 border-2 border-yellow-500/50 text-center group hover:border-yellow-400/70 transition-all duration-300 hover:bg-gradient-to-br hover:from-red-800/70 hover:to-red-700/70 relative overflow-hidden">
              ...
              <h4 class="text-3xl font-bold text-yellow-400 mb-3 group-hover:text-yellow-300 transition-colors duration-300">Pryda</h4>
            ...
            <div class="bg-gradient-to-br from-red-900/60 to-red-800/60 rounded-2xl p-8 border-2 border-yellow-500/50 text-center group hover:border-yellow-400/70 transition-all duration-300 hover:bg-gradient-to-br hover:from-red-800/70 hover:to-red-700/70 relative overflow-hidden">
              ...
              <h4 class="text-3xl font-bold text-yellow-400 mb-3 group-hover:text-yellow-300 transition-colors duration-300">LundiX</h4>
        ...
        <div class="text-center mb-8">
          <h4 class="text-xl font-bold text-yellow-400 mb-2">Alliance Commanders</h4>
