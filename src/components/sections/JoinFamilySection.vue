<template>
  <section id="join-family" class="relative min-h-screen flex items-center justify-center py-8 sm:py-12 lg:py-16 xl:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16" style="background: #1A1A1A;">
    <!-- Background Effects -->
      ...
      <div class="bg-black bg-opacity-70 rounded-3xl p-8 lg:p-12 border-2 border-red-800 mb-16">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center space-x-4 p-3 bg-red-800/20 rounded-lg border border-red-700/30">
                ...
                <div class="text-left">
                  ...
                  <div class="text-gray-400 text-sm">In-Game: WarLeader#1111</div>
                  <div class="text-gray-400 text-sm">Discord: WarLeader#0001</div>
                </div>
              </div>
              ...
              <div class="flex items-center space-x-4 p-3 bg-red-800/20 rounded-lg border border-red-700/30">
                ...
                <div class="text-left">
                  ...
                  <div class="text-gray-400 text-sm">In-Game: EagleLead#2222</div>
                  <div class="text-gray-400 text-sm">Discord: EagleLead#0001</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="text-center mt-12">
          ...
          <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a href="https://discord.gg/crimsonorder" target="_blank" rel="noopener noreferrer" class="btn-neon-discord group">
              <div class="btn-content">
                <span class="btn-icon">💬</span>
...
@keyframes neon-pulse-blue {
  0%, 100% {
    box-shadow: 0 0 15px #0088FF, inset 0 0 15px rgba(0,136,255,0.3);
  }
  50% {
    box-shadow: 0 0 25px #0088FF, 0 0 35px #0088FF, inset 0 0 15px rgba(0,136,255,0.3);
  }
}

@keyframes neon-pulse-purple {
  0%, 100% {
    box-shadow: 0 0 15px #7289DA, inset 0 0 15px rgba(114,137,218,0.3);
  }
  50% {
    box-shadow: 0 0 25px #7289DA, 0 0 35px #7289DA, inset 0 0 15px rgba(114,137,218,0.3);
  }
}

.btn-neon-telegram, .btn-neon-discord {
  position: relative;
  display: inline-flex;
  align-items: center;
...
.btn-neon-telegram:hover, .btn-neon-discord:hover {
  transform: translateY(-2px);
...
.btn-neon-telegram:focus, .btn-neon-discord:focus {
  outline: none;
